...
function FormPage(props) {
	...
	function submit() {
		...
		backend.post("fvv-ss20-go/submit", {form_data: formValues})
			.then(() => {
				...
				setTimeout(() => {
					setSubmitting(false);
					props.history.push('/fvv-ss20-go/verify' + getPathParams());
				}, 1500);
			})
			.catch(error => {
				...
				setTimeout(() => {
					setSubmitting(false);
					props.history.push('/fvv-ss20-go/form' + getPathParams());
